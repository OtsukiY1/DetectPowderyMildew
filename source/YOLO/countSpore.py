...
video_path = r"C:\Users\abeke\DetectPowderyMildewSpore\test\focused\38No2_masked.mp4"
...
input_csv = r"C:\Users\abeke\DetectPowderyMildewSpore\dataset_26-0209\ground_truth\38.csv"
###動画を保存する場所###
#ex) output_dir = r"\predict3"
output_dir = r"test\result"
...
#save_path = r"C:\Users\abeke\DetectPowderyMildewSpore\test\result\\" + output_dir +  f"\\{prefix}_result.mp4"
base_dir = r"C:\Users\abeke\DetectPowderyMildewSpore"
save_path = os.path.join(
    base_dir,
    "test",
    "result",
    f"{prefix}_result.mp4"
)
####
...
#output_frame_dir = r"C:\Users\abeke\DetectPowderyMildewSpore" + output_dir + f"\\{prefix}_new_object_frames"
