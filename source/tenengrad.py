...
def process_video(video_path, output_path, block_size=64, threshold_ratio=0.1):
...
if __name__ == "__main__":
    process_video(
        ...
        output_path=r"c:\Users\abeke\DetectPowderyMildewSpore\test\focused\38_masked.mp4",
